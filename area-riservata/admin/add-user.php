<?php
    ...
    $istituzioni = retrieve_all_istituzioni_id_login($dbMD);
        ...
        if(isset($_POST['newUserPassword']) && $_POST['newUserPassword'] != '') {
            ...
            if($check != 1){
               ...
               $error = $check;
                ...
                if(isset($_POST['istituzioniNewUser'])) {
                    $idIstituzione = $_POST['istituzioniNewUser'];
                }
...
<div clas="container">
    ...
    <form action="" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                    <label for="istituzioniNewUser">Istituzione</label>
                    <select name="istituzioniNewUser" id="istituzioniNewUser" class="selectSignup">
                        <?php foreach($istituzioni as $istituzione) { 

                            if($istituzione->ID == 'ISTITUZIONE-BASE'){ ?>
                                <option value="<?php echo $istituzione->ID ?>" selected="selected">Nessuna Istituzione</option>
                            <?php } else { ?>
                                <option value="<?php echo $istituzione->ID ?>"><?php echo $istituzione->LOGIN ?></option>
                            <?php }
