         ...
         if ($_POST['password'] == '') {
            ...
            if($check != 1){
               ...
               if ($pwd != $password){
                  ...
                  echo "<script>window.location.href = 'http://localhost/local/area-riservata/user/profile'</script>";
      ...
      <form action="" method="post">
         ...
         <div class="row">
            <div class="col-md-6">
               ...
               <input name="ipAutorizzati" type="text" value="<?php echo $ipAutorizzati ?>">
            </div>
